...
export class MovimentoService {
    ...
    find(movimentoPesquisa: MovimentoPesquisaDTO): Observable<PageMovimento> {
        return this._http.post<PageMovimento>(this._API_URL_ENDPOINT + this._url + '/busca', movimentoPesquisa);
    }
